---
layout: default
title: GPIOlib for Free Pascal on Linux
description: Simple and fast Pascal unit to control GPIO pins on Linux using the character device interface. Supports Raspberry Pi 4/5 and other boards.
---
...
- Run your program as **root**, or your user must be a member of the `gpio` group (or start the program using `sudo`).
